...
# Model definitions
# ----------------------------
class BasicCIFARModel(nn.Module):
    def __init__(self):
        super().__init__()
...
class AdvCIFARModel(nn.Module):
    def __init__(self, num_classes=10):
        super().__init__()
        # Block 1
        self.conv1 = nn.Conv2d(3, 32, kernel_size=3, padding=0)  # 32→30
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 32, kernel_size=3, padding=0)  # 30→28
        ...
        self.conv4 = nn.Conv2d(64, 64, kernel_size=3, padding=0)  # 14→12
        ...
        self.conv6 = nn.Conv2d(128, 128, kernel_size=3, padding=0)  # 6→4
        self.bn6 = nn.BatchNorm2d(128)
        self.pool3 = nn.MaxPool2d(2, 2)  # 4→2
...
# ----------------------------
def main():
    parser = argparse.ArgumentParser(description="CIFAR-10 training script (basic or adv architecture, standard/aug/fgsm/pgd training)")
    ...
    parser.add_argument("--output", type=str, default="cifar10_model.pt", help="Output model path")
    ...
    model = BasicCIFARModel() if args.arch == "basic" else AdvCIFARModel()
