...
# ----------------------------
def main():
    parser = argparse.ArgumentParser(description="CIFAR-10 MobileNet training (standard/aug/fgsm/pgd)")
    ...
    parser.add_argument("--output", type=str, default="cifar10_mobilenet.pt", help="Output model path")
