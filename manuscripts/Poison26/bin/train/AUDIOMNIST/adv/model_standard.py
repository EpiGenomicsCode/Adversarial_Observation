...
class AudioMNISTModel(nn.Module):
    def __init__(self):
        ...
        dummy_input = torch.zeros(1, 1, MAX_AUDIO_LENGTH)
        with torch.no_grad():
...
# Load Data
# ----------------------------
def load_data(data_path, batch_size, split_tsv="split_indices_model2.tsv"):
...
def main():
    ...
    parser.add_argument("--output", type=str, default="mnist_model2.pt", help="Model output name")
