...
# ----------------------------
def main():
    parser = argparse.ArgumentParser(description="MNIST RegNetX-400MF training (standard/aug/fgsm/pgd)")
    ...
    parser.add_argument("--output", type=str, default="mnist_regnetx.pt", help="Output model path")
