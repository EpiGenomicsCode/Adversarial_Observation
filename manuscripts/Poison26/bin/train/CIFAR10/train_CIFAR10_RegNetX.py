...
# ----------------------------
def main():
    parser = argparse.ArgumentParser(description="CIFAR-10 RegNetX-400MF training (standard/aug/fgsm/pgd)")
    ...
    parser.add_argument("--output", type=str, default="cifar10_regnetx.pt", help="Output model path")
